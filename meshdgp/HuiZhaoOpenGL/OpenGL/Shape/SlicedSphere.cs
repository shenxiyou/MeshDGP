    ...
    public sealed class SlicedSphere: DrawableShape
    {
        ...
        private void GetDefaultVertices( eDir s, double scale, out VertexT2dN3dV3d first, out VertexT2dN3dV3d second, out VertexT2dN3dV3d third )
        {
            ...
            case eDir.FrontTopRight:
                    t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), Vector3d.UnitY, Vector3d.UnitY * scale);
                    t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.0, 0.0), Vector3d.UnitZ, Vector3d.UnitZ * scale);
                    t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 0.0), Vector3d.UnitX, Vector3d.UnitX * scale);
                break;
            case eDir.FrontBottomRight:
                t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 0.0), Vector3d.UnitX, Vector3d.UnitX * scale);
                t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.0, 0.0), Vector3d.UnitZ, Vector3d.UnitZ * scale);
                t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), -Vector3d.UnitY, -Vector3d.UnitY * scale);
                break;
            case eDir.FrontBottomLeft:
                t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 0.0), Vector3d.UnitX, Vector3d.UnitX * scale);
                t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), -Vector3d.UnitY, -Vector3d.UnitY * scale);
                t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(1.0, 0.0), -Vector3d.UnitZ, -Vector3d.UnitZ * scale);
                break;
            case eDir.FrontTopLeft:
                t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(1.0, 0.0), -Vector3d.UnitZ, -Vector3d.UnitZ * scale);
                t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), Vector3d.UnitY, Vector3d.UnitY * scale);
                t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 0.0), Vector3d.UnitX, Vector3d.UnitX * scale);
                break;
            case eDir.BackTopRight:
                t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), Vector3d.UnitY, Vector3d.UnitY * scale);
                t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.0, 1.0), -Vector3d.UnitX, -Vector3d.UnitX * scale);
                t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.0, 0.0), Vector3d.UnitZ, Vector3d.UnitZ * scale);
                break;
            case eDir.BackBottomRight:
                t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), -Vector3d.UnitY, -Vector3d.UnitY * scale);
                t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.0, 0.0), Vector3d.UnitZ, Vector3d.UnitZ * scale);
                t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.0, 1.0), -Vector3d.UnitX, -Vector3d.UnitX * scale);
                break;
            case eDir.BackBottomLeft:
                t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), -Vector3d.UnitY, -Vector3d.UnitY * scale);
                t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(1.0, 1.0), -Vector3d.UnitX, -Vector3d.UnitX * scale);
                t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(1.0, 0.0), -Vector3d.UnitZ, -Vector3d.UnitZ * scale);
                break;
            case eDir.BackTopLeft:
                t1 = new VertexT2dN3dV3d(new OpenTK.Vector2d(0.5, 1.0), Vector3d.UnitY, Vector3d.UnitY * scale);
                t2 = new VertexT2dN3dV3d(new OpenTK.Vector2d(1.0, 0.0), -Vector3d.UnitZ, -Vector3d.UnitZ * scale);
                t3 = new VertexT2dN3dV3d(new OpenTK.Vector2d(1.0, 1.0), -Vector3d.UnitX, -Vector3d.UnitX * scale);
                break;
            }
            first = t1;
            second = t2;
