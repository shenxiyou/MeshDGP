...
namespace GraphicResearchHuiZhao
{
    ...
    {
       //SingleTextureGPU brick = new SingleTextureGPU();
        
        public PlaneShape()
        {
            Vertices = new Vector3[]
            {
                new Vector3(-1.0f,  1.0f,-2.2f),
                new Vector3(-1.0f, -1.0f,-2.2f),
                new Vector3( 1.0f, -1.0f,-2.2f),
                new Vector3( 1.0f,  1.0f,-2.2f),
        ...
        {
           // OpenGLOperators.Instance.RenderToTexture();
            ...
            //GL.BindTexture(TextureTarget.Texture2D, OpenGLOperators.Instance.FirstTexture);

            //GL.BindTexture(TextureTarget.Texture2D, OpenGLOperators.Instance.DepthTexture);
