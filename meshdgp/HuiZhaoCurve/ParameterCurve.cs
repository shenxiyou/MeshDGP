...
namespace GraphicResearchHuiZhao
{
    public partial class ParameterCurve
    {
        ...
        public TriMesh CreateMeshLine()
        {
            ...
            {
                line.Vertices.Add(new VertexTraits(-1 + t * 0.001, (-1 + t * 0.001) / Math.Tan(20), 0));
            }
            return line;
        }
        ...
        public TriMesh CreateMeshCricle(double radius)
        {
            ...
            for (int t = 0; t < VerticesNum; t++)
            {
                ...
                circle.Vertices.Add(new VertexTraits(0.2 * radius * Math.Cos(360 * t / VerticesNum), 0.5 * radius * Math.Sin(360 * t / VerticesNum), 0));
            }
            return circle;
        }
        ...
        public TriMesh CreateDoubleArcEpicycloidLine(double l, double b)
        {
            ...
            for (int t = 0; t < VerticesNum; t++)
            {
                dael.Vertices.Add(new VertexTraits(3 * b * Math.Cos(t * 360) + l * Math.Cos(3 * t * 360), 3 * b * Math.Sin(t * 360) + l * Math.Sin(3 * t * 360), 0));
            }
            return dael;
        }
        ...
        public TriMesh CreateHreatLine(double a)
        {
            TriMesh hl = new TriMesh();
            for (int t = 0; t < VerticesNum; t++)
            {
                hl.Vertices.Add(new VertexTraits(a * (1 + Math.Cos(360 * t)) * Math.Cos(360 * t), a * (1 + Math.Cos(360 * t)) * Math.Sin(360 * t), 0));
            }
            return hl;
        }
        ...
        public TriMesh CreateCircularHelixLine()
        {
            ...
            for (int t = 0; t < VerticesNum; t++)
            {
                chl.Vertices.Add(new VertexTraits((10 + 10 * Math.Sin(6 * t * 360)) * Math.Cos(t * 360), (10 + 10 * Math.Sin(6 * t * 360)) * Math.Sin(t * 360), 2 * Math.Sin(6 * t * 360)));
            }
            return chl;
        }
        ...
        public TriMesh CreateFermatCurve(double a)
        {
            ...
            for (int t = 0; t < VerticesNum; t++)
            {
                x = (a * Math.Sqrt(360 * t * 5 * 180 / Math.PI)) * Math.Cos(360 * t * 5);
                y = (a * Math.Sqrt(360 * t * 5 * 180 / Math.PI)) * Math.Sin(360 * t * 5);
                fc.Vertices.Add(new VertexTraits(x, y, 0));
            }
            //for (int t = VerticesNum / 4; t < VerticesNum / 2; t++)
            //{
            //    fc.Vertices.Add(new VertexTraits(-a * Math.Sqrt(360 * t * 5 * 180 / Math.PI) * Math.Cos(360 * t * 5), (-a * Math.Sqrt(360 * t * 5 * 180 / Math.PI)) * Math.Sin(360 * t * 5), 0));
            //}
            return fc;
        }
        ...
        public TriMesh CreateMeshButterfly()
        {
            // int VerticeNum = 4000;
            TriMesh circle = new TriMesh();
            for (int i = 0; i <= VerticesNum; i++)
            {
                double x = ((4 * Math.Sin(i * 2 * pi / VerticesNum) + 6 * Math.Cos(i * 2 * pi * 360 / VerticesNum)) * Math.Sin(i * 2 * pi / VerticesNum) * Math.Cos(Math.Log(1 + i * 2 * pi / VerticesNum) * i * 2 * pi / VerticesNum));
                double y = ((4 * Math.Sin(i * 2 * pi / VerticesNum) + 6 * Math.Cos(i * 2 * pi * 360 / VerticesNum)) * Math.Sin(i * 2 * pi / VerticesNum) * Math.Sin(Math.Log(1 + i * 2 * pi / VerticesNum) * i * 2 * pi / VerticesNum));
                double z = ((4 * Math.Sin(i * 2 * pi / VerticesNum) + 6 * Math.Cos(i * 2 * pi * 360 / VerticesNum)) * Math.Cos(i * 2 * pi / VerticesNum));
        ...
        {
            TriMesh epitrochoid = new TriMesh();
            float a = 0.5F;
            float b = 0.3F;
            float c = 0.5F;
            float theta;
            ...
            for (int i = 0; i < 20000; i++)
            {
                ...
                epitrochoid.Vertices.Add(new VertexTraits(((a + b) * Math.Cos(theta) - c * Math.Cos((a / b + 1) * theta)) / 10, ((a + b) * Math.Sin(theta) - c * Math.Sin((a / b + 1) * theta)) / 10, 0));
            }
        ...
        public TriMesh CreateInvoluteCurve(double a)
        {
            ...
            for (int t = 0; t <= VerticesNum; t++)
            {
                ...
                hl.Vertices.Add(new VertexTraits(x0 + s * Math.Sin(ang), y0 - s * Math.Cos(ang), 0));
            }
