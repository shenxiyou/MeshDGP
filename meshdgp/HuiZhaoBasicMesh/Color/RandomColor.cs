...
//        public Point(double lower, double upper)
//        {
//            X = lower;
//            Y = upper;
//        }
...
//        public static Color3 GetColor(ColorScheme scheme, Luminosity luminosity)
//        {
//            int H, S, B;
...
//        public static Color3[] GetColors(ColorScheme scheme, Luminosity luminosity, int count)
//        {
//            var ret = new Color3[count];
...
//        public static Color3[] GetColors(params Options[] options)
//        {
...
//        public static Color3 HsvToColor(int hue, int saturation, double value)
//        {
...
//            }
//            var c =new Color3(  Math.Floor(r * 255.0),
//                                  Math.Floor(g * 255.0),
//                                   Math.Floor(b * 255.0));
