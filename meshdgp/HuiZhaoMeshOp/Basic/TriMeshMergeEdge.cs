...
//        public static void MergeOneSide(TriMesh.HalfEdge hf)
//        {
...
//        public static void Merge(TriMesh mesh)
//        {
...
//        public static TriMesh.Vertex Merge(TriMesh.Face face)
//        {
//            Vector3D pos = TriMeshUtil.GetMidPoint(face);
//            return  Merge(face, pos);
//        }

//        public static TriMesh.Vertex Merge(TriMesh.Face face, Vector3D pos)
//        {
...
//            TriMeshModify.MergeOneSide(hf0);
//            TriMeshModify.MergeOneSide(hf1);
...
//        //    foreach (var hf in face.Halfedges)
//        //    {
//        //        if ( IsMergeable(hf.Edge) &&  IsMergeable(hf.Next.Edge))
//        //        {
//        //            face.HalfEdge = hf;
//        //            return true;
//        //        }
...
//        public static bool IsMergeable1(TriMesh.Edge edge)
//        {
//            TriMesh.Vertex v0 = edge.Vertex0;
//            TriMesh.Vertex v1 = edge.Vertex1;
//            //Check Verteices
...
//        //public static TriMesh.Vertex MergeEdge1(TriMesh.Edge edge, Vector3D position)
//        //{
//        //    TriMesh mesh = (TriMesh)edge.Mesh;
